...
# sys.path.insert(0,"/chengwenluo/Dropbox (Personal)/biovital_algorithms/analyticsengine")
...
# path1 = '/Users/chengwenluo/Dropbox (Personal)/test_different_time_slot/data_AWS/raw_data/'
# path2 = '/Users/chengwenluo/Dropbox (Personal)/test_different_time_slot/raw_truncated_/'
