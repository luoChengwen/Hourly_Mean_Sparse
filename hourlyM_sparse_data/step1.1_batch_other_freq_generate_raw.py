...
import os
import json
from analyticsengine.vitals.vitals import * # this is fixed seg
# from analyticsengine.vitals.vitals_flex import *
# from  analyticsengine.vitals.vitals_check import *
import datetime
import pytz
import re
...
path1 = '/Users/daisy/Desktop/test_different_time_slot/data_AWS/raw_data/'
path2 = '/Users/daisy/Desktop/test_different_time_slot/raw_truncated/'

# extract the first 120s in every 300s
incrment = 120
fre = 5*60
Tseg='5T'
...
for each_file in files:
    ...
    truncated_file = each_file.split('_')[0] + '_2in5raw_sample.json'
