...
path1 = '/Users/daisy/Dropbox/test_different_time_slot/raw_truncated/changeSP/'
path2 = '/Users/daisy/Dropbox/test_different_time_slot/Report_com/changeSP/'
        ...
        # if each_file.startswith('5b1'):
            ...
            for e in timeseg:
                if e == 60:
                    ...
                    with open(pathTemp + each_file.split('_')[0] + '_2in5_raw_sample.json_BI_output.json') as f:
                        rawBI = json.load(f)
                        print(e)
                        rawBI = pd.DataFrame.from_dict(rawBI)
                        TBCal = 'bi'
                ...
                if leng>0:
                    ...
                    print('no available data point left')